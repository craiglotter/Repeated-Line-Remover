...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.ToolTip1.SetToolTip(Me.ButtonOperationLaunch, "Launches Repeated Line Remover Operation")
        '
        'Button_Pause1
        '
        ...
        Me.ToolTip1.SetToolTip(Me.Button_Pause1, "Pauses Repeated Line Remover Operation")
        ...
        Me.ToolTip1.SetToolTip(Me.Button_ExitThread, "Exits Repeated Line Remover Operation")
        ...
        Me.Label1.Text = "BUILD 20051213.1"
...
#End Region
    ...
    Private Sub Error_Handler(ByVal message As String)
        ...
        Catch ex As Exception
            MsgBox("An error occurred in Repeated Line Remover's error handling routine. The application will try to recover from this serious error.", MsgBoxStyle.Critical, "Critical Error Encountered")
        End Try
    End Sub
